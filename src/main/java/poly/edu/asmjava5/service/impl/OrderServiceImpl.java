...
import poly.edu.asmjava5.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Transactional
    public List<HistoryOrder> findOrderByUsername(String username) {
        return orderRepository.findOrderByUsername(username);
    }

    @Override
    public Page<Order> findAllByUsernameLike(String username, Pageable pageable) {
        return orderRepository.findAllByUsernameLike(username, pageable);
    }
    ...
    //    @Override
//    public Page<Order> findAllByUsernameContaining(String username, Pageable pageable) {
//        return orderRepository.findAllByUsernameContaining(username, pageable);
//    }
